            ...
            <div class="header-content">
                <div class="col-md-4">
                    <div class="header-left">
                        ...
                        <div class="sel-box">
                            <a href="tel:+12345678900">start from: 45:01:34:00</a>
                        </div>
                    </div>
                </div>
...
<nav class="navbar-default visible-xs">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{route('/')}}">
                <img src="{{asset('front/images/logo.png')}}" alt="logo" class="img-responsive">
            </a>
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <form class="search-form">
                    ...
                    <div class="items text-left">
                        ...
                        <div class="item-choose-main">
                            <div class="item-choose">
                                <ul>
                                    <li>
                                        <img src="{{asset('front/images/items1.png')}}" alt="item1" class="img-responsive">
                                    </li>
                                    <li>
                            ...
                            <div class="item-choose">
                                <ul>
                                    <li>
                                        <img src="{{asset('front/images/items2.png')}}" alt="item1" class="img-responsive">
                                    </li>
                                    <li>
                                        <h3>T-shirt for Women</h3>
                                        <p>Price : $ 99.00</p>
    ...
    <div class="container">
        <div class="row">
            <div class="about-heading text-center">
                <h2>{{env('APP_NAME')}}</h2>
                <p><a href="{{route('/')}}">home</a> <i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i> <span>My Account</span></p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="footer-main">
                    <div class="col-md-3 col-sm-6">
                        <div class="footer-logo">
                            <a href="#"><img src="{{asset('front/images/footer-logo.png')}}" alt="footer-logo" class="img-responsive"></a>
        ...
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <div class="copywright">
                    <p>Copyright &copy; {{date('Y')}}. All right reserved by <a href="index.html">E-BUY</a></p>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="payment text-right">
                    <img src="{{asset('front/images/card1.png')}}" alt="card" class="img-responsive">
                    <img src="{{asset('front/images/card2.png')}}" alt="card" class="img-responsive">
                    <img src="{{asset('front/images/card3.png')}}" alt="card" class="img-responsive">
                    <img src="{{asset('front/images/card4.png')}}" alt="card" class="img-responsive">
                    <img src="{{asset('front/images/card5.png')}}" alt="card" class="img-responsive">
                </div>
            </div>
        </div>
    </div>
...
<script src="{{asset('front/js/handleCounter.js')}}"></script>
