...
<head>
    ...
    <style type="text/css">
        ...
        body {
            font-family: Junge, Times New Roman;
            position: relative;
            width: 21cm;
            height: 29.7cm;
            margin: 0 auto;
...
<main>
    <center>
        <img src="https://2.bp.blogspot.com/-LGDs96H28_I/XS3q1Z49FPI/AAAAAAAAABw/7XbypZuan1sCfXduJWzmX4RkYxwRUhwEgCK4BGAYYCw/s113/ae.png" alt="" width="100px">
        <h3>Ahsan Enterprize</h3>
    </center>
    <h1  class="clearfix">
